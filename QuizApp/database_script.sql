...
CREATE TABLE IF NOT EXISTS `quiz_exam_questions` (
  `examcode` varchar(128) NOT NULL PRIMARY KEY,
...
ALTER TABLE quiz_exam_questions ADD CONSTRAINT fk_examcode FOREIGN KEY (examid) REFERENCES quiz_exams(id) ON UPDATE CASCADE ON DELETE CASCADE;
